  ...
  head: () => ({
    meta: [
      ...
      { title: "Vibha Technologies — SAP Treasury & Finance Consulting" },
      {
        name: "description",
        content:
          "Specialist SAP Treasury, Cash Management and Finance Transformation consultancy. 16+ years of banking and SAP expertise across the UK, Europe, Middle East and beyond.",
      },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          url: "https://vibhatechnologies.co.uk",
          logo: "https://vibhatechnologies.co.uk/favicon.png",
          email: "contact@vibhatechnologies.co.uk",
          telephone: "+44 7466 854499",
          foundingDate: "2019",
          address: {
            "@type": "PostalAddress",
            streetAddress: "67 Hall Road",
            addressLocality: "London",
            postalCode: "E6 2NG",
            addressCountry: "GB",
          },
          areaServed: ["United Kingdom", "Europe", "Middle East", "United States", "India"],
          sameAs: ["https://www.linkedin.com/company/vibha-technologies"],
        }),
      },
    ],
  }),
